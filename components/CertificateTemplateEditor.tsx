            ...
            <form onSubmit={handleSubmit} className="space-y-6 lg:sticky lg:top-6">
                            ...
                            <div key={key} className="relative flex items-start">
                                <div className="flex items-center h-5">
                                    <input
                                        ...
                                        className="focus:ring-teal-500 h-4 w-4 text-teal-500 border-slate-300 rounded dark:bg-slate-600 dark:border-slate-500"
                                    />
                                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="mt-1 w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm dark:bg-slate-700 dark:border-slate-600"
                ...
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm dark:bg-slate-700 dark:border-slate-600 disabled:opacity-50"
