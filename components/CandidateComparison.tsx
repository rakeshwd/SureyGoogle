...
const COMPARISON_COLORS = ['#4F46E5', '#10B981', '#F59E0B', '#EF4444', '#3B82F6'];
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 p-4">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                <div className="flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700">
                    <h2 className="text-xl font-bold">Candidate Comparison: <span className="text-indigo-600 dark:text-indigo-400">{questionnaire.title}</span></h2>
